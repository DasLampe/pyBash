...
INSERT INTO `pyBash_quotes` VALUES (1,'2012-06-13 22:30:21','DasLampe','<pyBot Werner> Ja was gibt\'s\r\n<Ditti> Nerv nicht, Werner :D\r\n<pyBot Werner> Ja was gibt\'s\r\n<Ditti> Verdammt :D',2),(2,'2012-06-13 22:30:21','Achtzig','<tussi> mmmmmmmmmmmmh... den gibts ja noch immer http://www.pytal.de/nickpage,104267\r\n<Achtzig> Den solte man mal aufessen :-D',2),(3,'2012-06-13 23:16:20','Ditti','<Ditti4> Mach ich jeden Abend s. Ab 21:00 \"schlafe\" ich immer, oder soll es zumindest. ;)\r\n<Achtzig> Mit einer Taschenlampe unter der Decke :-D\r\n<Achtzig> So haben wir früher heimlich gelesen ;-)\r\n<Achtzig> Bücher - so Dinger mit Papierseiten :-)',2),(4,'2012-06-13 23:16:20','Ditti','<Achtzig> Ja, wenn Du die gleichen meinst, die ich meine. Oder meinst Du Uglu?\r\n<Ditti4> Was fürn Ding?\r\n<Ditti4> Ich kenn nur Iglu. :D',2);
...
-- Dump completed on 2012-06-16  4:18:34
